...
private:
	...
	/**
	 * @brief
	 *		Reads the shader file and returns the shader code as a string.
	 *
	 * @param filename
	 *		The file path to the shader.
	 *
	 * @return
	 *		The shader code as a string.
	 */
	static std::string read_shader_file(const char* filename);
	/**
	 * @brief
	 *		Prints the error details for the shader or program.
	 *
	 * @param is_shader
	 *		Whether the error is for a shader or program.
	 * @param id
	 *		The ID of the shader or program.
	 * @param name
	 *		The name of the shader or program.
	 */
